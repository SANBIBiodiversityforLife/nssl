...
/* themes/sanbi/templates/node--species.html.twig */
class __TwigTemplate_adbc43c805252d34d463a8a250925e10af1155a83ea1388d6a1a60cb634beb7d extends Twig_Template
{
    ...
    {
        $tags = array("set" => 69, "if" => 81, "trans" => 102);
...
(isset($context["view_mode"]) ? $context["view_mode"] : null)) ? (\Drupal\Component\Utility\Html::getClass((isset($context["view_mode"]) ? $context["view_mode"] : null))) : ("")), 5 => "clearfix");
  ...
  ";
        // line 88
        if ( !twig_test_empty($this->getAttribute($this->getAttribute((isset($context["node"]) ? $context["node"] : null), "field_sensitivity", array()), "value", array()))) {
            // line 89
            echo "  <button type=\"button\" class=\"btn btn-danger\" id=\"sspFlag\"><span class=\"glyphicon glyphicon-flag\" aria-hidden=\"true\"></span> Sensitive</button>
  ";
        } else {
            // line 91
            echo "  <button type=\"button\" class=\"btn btn-info\" id=\"sspFlag\"><span class=\"glyphicon glyphicon-flag\" aria-hidden=\"true\"></span> Not sensitive</button>
  ";
        }
        // line 93
        echo "  
...
";
    ...
    {
        return "themes/sanbi/templates/node--species.html.twig";
    }
    ...
    {
        return array (  127 => 107,  119 => 103,  117 => 102,  113 => 101,  109 => 100,  106 => 99,  104 => 98,  98 => 95,  94 => 94,  91 => 93,  87 => 91,  83 => 89,  81 => 88,  75 => 86,  67 => 83,  62 => 82,  60 => 81,  56 => 80,  50 => 78,  48 => 74,  47 => 73,  46 => 72,  45 => 71,  44 => 70,  43 => 69,);
    }
}
/* {#*/
/* /***/
...
/*   {{ title_suffix }}*/
/*   */
/*   {% if node.field_sensitivity.value is not empty %}*/
/*   <button type="button" class="btn btn-danger" id="sspFlag"><span class="glyphicon glyphicon-flag" aria-hidden="true"></span> Sensitive</button>*/
/*   {% else %}*/
/*   <button type="button" class="btn btn-info" id="sspFlag"><span class="glyphicon glyphicon-flag" aria-hidden="true"></span> Not sensitive</button>*/
/*   {% endif %}*/
/*   */
